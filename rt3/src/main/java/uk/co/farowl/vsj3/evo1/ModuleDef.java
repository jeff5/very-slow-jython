...
public class ModuleDef {
    ...
    static class MethodDef {
         ...
         * PyMethodDef, and is not used as a member of descriptors or
         * methods and extension writers do not declare instances of
         * them. Instead, we reify the argument information from the

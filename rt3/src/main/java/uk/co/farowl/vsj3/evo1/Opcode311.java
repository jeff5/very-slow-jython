...
class Opcode311 {
    ...
    /**
     * Empty CACHE that follows certain opcodes as generated by CPython:
     * we treat it as a no-op since we do not implement the
     * optimisations it exists to support.
     */

...
public class PySequence extends Abstract {
    ...
    public static PyTuple tuple(Object o)
    ...
    public static PyList list(Object o)
            throws PyBaseException, Throwable {
     ...
     * (typically a {@link PyBaseException TypeError}).
     *
    ...
    public static <E extends PyBaseException> List<Object>
            fastList(Object o, Supplier<E> exc) throws E, Throwable {
    ...
    public static interface OfInt extends Of<Integer> {
        ...
        /**
         * Get the int item from the sequence at a given index
         * {@code i}.
         *
         * @param i index
         * @return item at index {@code i}.
    ...
    static abstract class Delegate<E, S>
         ...
         * to a Python {@link PyBaseException OverflowError}.
         *
         ...
         * {@link PyBaseException OverflowError}.
         *
         ...
         */
        Object __mul__(Object n) throws PyBaseException, Throwable {
            if (PyNumber.indexCheck(n)) {
                int count = PyNumber.asSize(n,
        ...
        public int index(Object v, Object start, Object stop)
            ...
            throw PyErr.format(PyExc.ValueError,
                    "%s.index(x): x not in %s", getType().getName(),
                    getTypeName());
        }
        ...
        /**
         * Creates an {@link PyBaseException IndexError} with the
         * message "{@link #getTypeName()} KIND index out of range",
         * e.g. "list assignment index out of range".
         *
         * @param kind word to insert for KIND: "" or "assignment".
         * @return an exception to throw
         */
        final protected PyBaseException rangeIndexError(String kind) {
            String space = kind.length() > 0 ? " " : "";
            return PyErr.format(PyExc.IndexError,
                    "%s%s%s index out of range", getTypeName(), space,
                    kind);
        }
         ...
         * @return an exception to throw
         */
        private PyBaseException concatOverflow() {
            return PyErr.format(PyExc.OverflowError,
                    "concatenated %s is too long", getTypeName());
        }
         ...
         * @return an exception to throw
         */
        private PyBaseException repeatOverflow() {
            return PyErr.format(PyExc.OverflowError,
                    "repeated %s is too long", getTypeName());
        }

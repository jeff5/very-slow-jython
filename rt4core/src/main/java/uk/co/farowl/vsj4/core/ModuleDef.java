...
public class ModuleDef {
    ...
    /**
     * Create a definition for the module module defined in Java,
     * discovered by introspection of the class provided. We build a
     * description of the attributes identified by annotations. (See
     * {@link Exposed}.)
     * <p>
     * A lookup object is essential to create descriptors on the

...
public class InternalFormat {
     ...
     */
    public static FormatSpec fromText(String text)
    ...
    public static abstract class AbstractFormatter
         ...
         */
        protected final FormatSpec spec;
         ...
         */
        public AbstractFormatter(StringBuilder result,
                FormatSpec spec) {
            this.spec = spec;
            this.result = result;
         ...
         */
        public AbstractFormatter(FormatSpec spec, int width) {
     ...
     * indicate "unspecified". {@code FormatSpec} objects may be merged
     * such that one {@code FormatSpec} provides values, during the
     * construction of a new {@code FormatSpec}, for attributes that are
     * unspecified in a primary source.
     * <p>
     ...
     *     ...
     *         FormatSpec spec = InternalFormat.fromText(specString);
    ...
    public static class FormatSpec {
        ...
        /**
         * Return a merged {@code FormatSpec} object, in which any
         * attribute of this object that is specified (or {@code true}),
         * has the same value in the result, and any attribute of this
         * object that is unspecified (or {@code false}), has the value
         * that attribute takes in the other object. Thus the second
         * object supplies default values. (These defaults may also be
         * unspecified.) The use of this method is to allow a
         * {@code FormatSpec} constructed from text to record exactly,
         * and only, what was in the textual specification, while the
         ...
         * @return a new {@code FormatSpec} object.
         */
        public FormatSpec withDefaults(FormatSpec other) {
     ...
     * specification into an {@code FormatSpec} object.
     */
    private static class Parser {
        ...
        FormatSpec parse() {
            ...
            if (scanPast('0')) {
                 ...
                 * set already.
                 */
                if (!FormatSpec.specified(fill)) {
                    fill = '0';
                    if (!FormatSpec.specified(align)) {
                        /*

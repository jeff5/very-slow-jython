...
class marshalTest extends UnitTestSupport {
    ...
    abstract static class AbstractLoadTest {
         ...
         * the expressions using the script at
         * {@code ~/tools/python/lib/marshal_test.py}.
         *
        ...
        static Stream<Arguments> objectLoadExamples() {
            return Stream.of( //
                    ...
                    loadExample("'sæll'", // tc='t'
                            bytes(0x74, 0x05, 0x00, 0x00, 0x00, 0x73,
                                    0xc3, 0xa6, 0x6c, 0x6c),
                            "sæll"),
                    loadExample("'🐍'", // tc='t'
                            bytes(0x74, 0x04, 0x00, 0x00, 0x00, 0xf0,
                                    0x9f, 0x90, 0x8d),
                            "🐍"),
                    loadExample("()", // tc=')'

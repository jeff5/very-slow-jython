...
Much of this code originated in Tobias Kohn's Java-pegen project.
It has been mildly adapted for use in Jython.
"""
...
def to_java_name(name: str, *, prefix=None,
    ...
    `start_with_upper`, if given and not None, determines the case of the first
    letter of the result (after the optional prefix). Letters following '_'
    in the original are sentto uppercase.

    If the final result would be a reserved word (Java keywords and some others),

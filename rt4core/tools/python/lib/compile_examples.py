# Generate compiled Python files as test material
...
# It is written in ./__pycache__ and called NAME.cpython-VERSION.pyc
# and we use this to generate .pyc as test material for the byte
# code interpreter.
CACHE = '__pycache__'

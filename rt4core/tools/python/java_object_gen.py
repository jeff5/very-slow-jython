...
#
# See the files in rt4core/src/main/javaTemplate for examples.
...
from template import ImplementationGenerator
from template import PyFloatGenerator
from template import PyLongGenerator
from template import PyUnicodeGenerator
...
class ImplementationTemplateProcessorFactory:
    ...
    def __init__(self, source_dir, dest_dir, error, verbose=False):
        ...
        # Confirm
        if self.verbose:
            # cwd is the project directory e.g. ~/rt4core
            cwd = os.getcwd()

# -*- coding: utf-8 -*-
#
# The Very Slow Jython Project documentation build configuration file, created by
...
#
# html_title = u'The Very Slow Jython Project v0.1'
...
htmlhelp_basename = 'TheVerySlowJythonProjectdoc'
...
latex_documents = [
    (master_doc, 'TheVerySlowJythonProject.tex', u'The Very Slow Jython Project Documentation',
     u'Jeff Allen', 'manual'),
]

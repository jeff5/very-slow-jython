...
public class TestInterp4 {
    ...
    private static abstract class Frame {
        ...
        /**
         * Do everything constructor on which the others depend.
         *
         * <ul>
        ...
        protected Frame(Frame back, Code code, Map<String, Object> globals,
            ...
            /*
             * We may need to create cell variables locally for nested
             * blocks to access, and if there is a closure, it also
             * supplies cells, the values of variables free in this block.
             */
    ...
    private static class ExecutionFrame extends Frame
         ...
         * <code>PyFrame</code> with the storage and mechanism to execute

...
public class TestInterp1 {
    ...
    private void checkExample(mod module, RefSymbol[][] ref) {
        ...
        // The supplied name nameLists tells us how many code blocks
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    "g",
                    arguments(list(), null, list(), list(), null, list()),
                    list(Assign(list(Name("y", Store)), BinOp(Name("x", Load), Add, Num(1)))),
                    list(),
                    null),
                Pass()),
            list(),
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    "g",
                    arguments(list(), null, list(), list(), null, list()),
                    list(Assign(list(Name("x", Store)), Num(4200))),
                    list(),
                    null),
                Pass()),
            list(),
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    "g",
                    arguments(list(), null, list(), list(), null, list()),
                    list(Global(list("x")), Assign(list(Name("x", Store)), Num(4200))),
                    list(),
                    null),
                Pass()),
            list(),
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    ...
                    list(),
                    null),
                Assign(list(Name("y", Store)), BinOp(Name("x", Load), Add, Num(1)))),
            list(),
            null),
        Pass()))
        ;
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    ...
                    list(),
                    null),
                Assign(list(Name("x", Store)), Num(420))),
            list(),
            null),
        Pass()))
        ;
        ...
        FunctionDef(
            ...
            list(
                FunctionDef(
                    "g",
                    arguments(list(), null, list(), list(), null, list()),
                    list(Nonlocal(list("x")), Assign(list(Name("x", Store)), Num(4200))),
                    list(),
                    null),
                Assign(list(Name("x", Store)), Num(420))),
            list(),
    ...
    list(
        FunctionDef(
            ...
            list(),
            null),
        Assign(list(Name("x", Store)), Num(42))))
        ;
        // @formatter:on
                ...
                FunctionDef(
                    ...
                    list(
                        FunctionDef(
                            ...
                            null),
                        Global(list("x")),
                        Assign(list(Name("x", Store)), Num(4200))),
                    list(),
                    null),
                Assign(list(Name("y", Store)), BinOp(Name("x", Load), Add, Num(1)))),
            list(),
                ...
                FunctionDef(
                    ...
                    list(
                        FunctionDef(
                            "h",
                            arguments(list(), null, list(), list(), null, list()),
                            list(Nonlocal(list("x")), Assign(list(Name("x", Store)), Num(42000))),
                            list(),
                            null),
                        Pass()),
                    list(),

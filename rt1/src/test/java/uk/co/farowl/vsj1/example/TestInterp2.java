...
checkCode(module, new RefCode[]{ // kwargprog
    ...
    new RefCode( //
        ...
        3, // co_flags
        new String[]{}, // co_names,
        new String[]{"r","i","sum","diff","prod","s"}, // co_varnames,
        new String[]{"i","r"}, // co_cellvars,
        new String[]{}, // co_freevars
        "p" ),
    new RefCode( //
        ...
        95, // co_flags
        new String[]{}, // co_names,
        new String[]{"r","q","j","i","args","kwargs","mysum"}, // co_varnames,
        new String[]{}, // co_cellvars,
        new String[]{}, // co_freevars
        "sum" ),
    new RefCode( //

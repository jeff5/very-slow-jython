...
.. note::
   ...
   put the directory ``runtime/src/test/python`` on the ``sys.path``,
...
but there is a module at ``runtime/src/test/python/symbolutil.py``
that will help::
...
at ``runtime/src/test/python/symtable_testgen.py``,
and it generates the test material for
``runtime/src/test/.../treepython/TestInterp1.java``,
...
There is a project-specific tool in ``runtime/src/test/python/codeutil.py``
...
``runtime/src/test/.../treepython/TestInterp2.java``,
from which the next few Java code snippets were taken.
The program ``runtime/src/test/python/symtable_testgen.py``
...
For the full story,
visit ``runtime/src/test/.../treepython/TestInterp2.java`` in the code base.
...
``runtime/src/test/.../treepython/TestInterp3.java`` in the code base.
The work in this section is demonstrated there, with test material generated by
``runtime/src/test/python/variable_access_testgen.py``.
...
compiled and executed by ``runtime/src/test/python/variable_access_testgen.py``.
...
************************
    ...
    ``runtime/src/test/java/.../vsj1/example/treepython/TestInterp4.java``
...
====================
    ...
    Code fragments in this section are taken from
    ``runtime/src/test/java/.../vsj1/example/treepython/TestInterp5.java``
    in the project source.

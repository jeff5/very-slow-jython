...
.. note::
   ...
   put the directory ``rt1/src/main/python`` on the ``sys.path``,
...
but there is a module at ``rt1/src/main/python/symbolutil.py``
that will help::
...
at ``rt1/src/test/python/symtable_testgen.py``,
and it generates the test material for
``rt1/src/test/.../treepython/TestInterp1.java``,
...
There is a project-specific tool in ``rt1/src/main/python/codeutil.py``
...
``rt1/src/test/.../treepython/TestInterp2.java``,
from which the next few Java code snippets were taken.
The program ``rt1/src/test/python/symtable_testgen.py``
...
For the full story,
visit ``rt1/src/test/.../treepython/TestInterp2.java`` in the code base.
...
``rt1/src/test/.../treepython/TestInterp3.java`` in the code base.
The work in this section is demonstrated there, with test material generated by
``rt1/src/test/python/variable_access_testgen.py``.

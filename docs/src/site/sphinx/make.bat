...
if "%SPHINXBUILD%" == "" (
	set SPHINXBUILD=sphinx-build --no-color
)
...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\TheVerySlowJythonProject.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\TheVerySlowJythonProject.ghc
	goto end
)

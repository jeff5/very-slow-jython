 ...
 * {@link PyWrapperDescr#__get__(PyObject, PyType)}.
 */
...
class PyMethodWrapper extends AbstractPyObject {
     ...
     */
    PyMethodWrapper(PyWrapperDescr descr, PyObject self) {
        super(TYPE);
        this.descr = descr;
        this.self = self;
    }
    ...
    protected PyObject __objclass__() {
        PyObject c = descr.objclass;
        return c;
    }

    @Getter
    // Compare CPython wrapper_name in descrobject.c
    protected PyObject __name__() {
    ...
    protected PyObject __text_signature__() {
    ...
    protected PyObject __qualname__() throws AttributeError, Throwable {

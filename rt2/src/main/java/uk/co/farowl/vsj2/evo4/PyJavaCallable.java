 ...
 */
class PyJavaCallable implements PyObject, VectorCallable {

    /** The type of Python object this class implements. */
    static final PyType TYPE = PyType.fromSpec( //
            new PyType.Spec("builtin_function_or_method",
                    PyJavaCallable.class, MethodHandles.lookup()));
    ...
    PyJavaCallable(MethodDef def, PyObject self, MethodHandle handle,
            PyUnicode module) {
        this.methodDef = def;
        this.self = self;
        this.module = module;

 ...
 * <p>
 * The order matches CPython's enumeration of operations used in the
 * argument to {@code COMPARE_OP}, so that we can rely on it in the
 * CPython bye code interpreter.
 */
enum Comparison {

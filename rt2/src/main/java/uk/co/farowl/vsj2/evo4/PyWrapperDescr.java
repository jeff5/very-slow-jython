...
abstract class PyWrapperDescr extends Descriptor {
    ...
    abstract PyObject callWrapped(PyObject self, PyTuple args,
    ...
    private PyObject __repr__() { return descrRepr("slot wrapper"); }

    // Compare CPython wrapperdescr_get in descrobject.c
    @Override
    protected PyObject __get__(PyObject obj, PyType type) {
        if (obj == null)
            /*

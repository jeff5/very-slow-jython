...
public class PyRT {
    ...
    static class BinaryOpCallSite extends MutableCallSite {
         ...
         */
        @SuppressWarnings("unused")
        private PyObject fallback(PyObject v, PyObject w)
                throws Throwable {
            fallbackCalls += 1;
            PyType vType = v.getType();
             ...
             * mutable).
             */
            MethodHandle slotv = op.getSlot(vType);
            MethodHandle slotw;
            ...
            // Compute the result for this case
            return (PyObject) resultMH.invokeExact(v, w);
        }
